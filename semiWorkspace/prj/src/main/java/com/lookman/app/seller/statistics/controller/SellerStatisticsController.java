package com.lookman.app.seller.statistics.controller;
...
@WebServlet("/seller/home/statistics")
public class SellerStatisticsController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			if(loginSellerVo!=null) {
				...
				SellerStatisticsVo sssVo=ss.getSellerStatistics(loginSellerVo);
				List<SellerOrderListVo> solVoList=ss.getSimplerOrderListPrice(loginSellerVo);			//수정완료
				
				req.setAttribute("spsVo", spsVo);
				req.setAttribute("sssVo", sssVo);
				req.setAttribute("solVoList", solVoList);
				req.getRequestDispatcher("/WEB-INF/views/seller/statistics/statistics.jsp").forward(req, resp);
