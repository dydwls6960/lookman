          ...
          <section class="details__text">
            ...
            <div class="details__action">
              ...
              <div class="details__action--buttons">
                <button class="buy-btn" data-member-no="${sessionScope.loginMemberVo.memberNo}">구매</button>
                <button class="fav-btn ${requestScope.dto.favorite ? 'active' : ''}" data-product-no="${requestScope.dto.productNo}" data-member-no="${sessionScope.loginMemberVo.memberNo}">
	                <c:if test="${requestScope.dto.favorite}">
	                ...
	                <c:if test="${not requestScope.dto.favorite}">                
                ...
                <button class="cart-btn" data-member-no="${sessionScope.loginMemberVo.memberNo}"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
