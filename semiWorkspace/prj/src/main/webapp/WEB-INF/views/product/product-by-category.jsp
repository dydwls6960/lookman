	...
	<div class="container">
		...
		<main class="main main-list">
					...
					<a href="/app/products/${dto.productNo}">
						<div class="item-container">
							...
							<div class="item-container__desc">
								...
								<p class="item-container__desc--name">${dto.sellerName}|
									${dto.productName}</p>
			...
			<c:if test="${empty requestScope.dtoList}">
				<div class="main-list--item" style="grid-column: span 3;">
					<h3 style="text-align: center; padding-top: 24px;">상품 목록이 비어있습니다.</h3>
				</div>
			</c:if>
		</main>
