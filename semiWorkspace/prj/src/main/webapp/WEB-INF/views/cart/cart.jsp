			...
			<table class="cart__table">
				<thead>
					<tr class="cart__table--header">
						...
						<th><input type="checkbox" name="check-all" id="check-all"
							checked></th>
						<th>상품명(옵션)</th>
						<th>가격</th>
						<th>수량</th>
				...
				<tbody>
					<c:forEach var="dto" items="${requestScope.dtoList}">
						<tr>
							<td>${dto.rownum}</td>
							<td class="checkbox-td"><input class="item-checkbox"
								type="checkbox" name="${dto.cartNo}" id="${dto.cartNo}" checked></td>
							<td>
								<div class="product-details">
									<a href="/app/products/${dto.productNo}" class="product-link"><img
