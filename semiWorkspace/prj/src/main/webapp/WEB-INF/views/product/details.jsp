    ...
    <%@ include file="/WEB-INF/views/layout/util.jsp" %>
      <%@ include file="/WEB-INF/views/layout/splide.jsp" %>
        <%@ include file="/WEB-INF/views/layout/vex-modal.jsp" %>
          <script src="/app/resources/js/member/product/details.js" defer></script>
          ...
          <section class="details__text">
            ...
            <div class="details__action">
              ...
              <div class="details__action--buttons">
                ...
                <button class="fav-btn ${requestScope.dto.favorite ? 'active' : ''}"
                  data-product-no="${requestScope.dto.productNo}"
                ...
                <button class="cart-btn" data-member-no="${sessionScope.loginMemberVo.memberNo}"><svg width="24"
