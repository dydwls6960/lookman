...
<script type="text/javascript" src="/app/resources/js/inquiry.js" defer></script>
	...
	<div class="container">
		...
		<main class="main main-product-inquiry">
			<section class="inquiry" id="inquiry">
				<h2 class="inquiry__heading">상품문의
					(${requestScope.pidtoList.size()})</h2>
				<c:forEach var="inquiry" items="${requestScope.pidtoList}">
					<div class="inquiry__item">
						<div class="inquiry__item--upper">
							...
							<div class="upper__div">
								<div class="upper__div--text">
									<span class="inquiry__date"> <c:if
											test="${not empty inquiry.responseDate}">
                                ${inquiry.responseDate}
                            </c:if> <c:if test="${empty inquiry.responseDate}">
						...
						<div class="inquiry__item--mid">
							<a href="/app/products/${inquiry.productNo}"> <img
								src="/app/resources/img/product/${inquiry.thumbnailFilename}"
						...
						<div class="inquiry__item--lower">
							...
							<c:if test="${not empty inquiry.responseContent}">
								<p class="inquiry__response">답변: ${inquiry.responseContent}
								</p>
							</c:if>
						</div>
					</div>
