...
@WebServlet("/seller/home/order/state")
public class SellerOrderStateController extends HttpServlet{
	private SellerService ss;
	public SellerOrderStateController() {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			if(loginSellerVo!=null) {
				...
				req.getRequestDispatcher("/WEB-INF/views/seller/order/state.jsp").forward(req, resp);
