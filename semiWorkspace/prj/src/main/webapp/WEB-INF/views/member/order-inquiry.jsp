  ...
  <head>
    ...
    <%@ include file="/WEB-INF/views/layout/util.jsp" %>
      ...
      <%@ include file="/WEB-INF/views/layout/vex-modal.jsp" %>
        <script type="text/javascript" src="/app/resources/js/member/order/order-inquiry.js" defer></script>
  </head>
              ...
              <div class="inquiry__item">
                ...
                <div class="inquiry__item--mid">
                  <a href="/app/products/${inquiry.productNo}">
                    <img src="/app/resources/img/product/${inquiry.thumbnailFilename}" alt="img" class="inquiry__img">
                  </a>
