          ...
          <table class="cart__table">
            ...
            <tbody>
              <c:forEach var="dto" items="${requestScope.dtoList}">
                <tr>
                  <td>${dto.rownum}</td>
                  <td class="checkbox-td"><input type="checkbox" name="${dto.cartNo}" id="${dto.cartNo}" checked></td>
                  <td>
                    <div class="product-details">
                      ...
                      <div class="product-detail__text">
                        <p class="cart__seller-product">[${dto.sellerName}] ${dto.productName}</p>
                        <%-- <p class="cart__product-name">${dto.productName}</p> --%>
                          <p class="cart__order-options">
                            옵션: ${dto.colorName} / ${dto.sizeName} / 재고 ${dto.inventoryQuantity}개 남음
                          </p>
                      </div>
                    </div>
                  </td>
                  ...
                  <td><button class="del-btn" data-cart-no="${dto.cartNo}"
                      data-member-no="${dto.memberNo}">삭제하기</button>
                  </td>
                </tr>
              </c:forEach>
            </tbody>
          </table>
          <button class="del-sel-button">
            선택삭제
          </button>
